...
<header class="header" id="header">
    ...
    <section>
        <h2 class="productosDestacados"
            style="margin:0; text-align:center;margin-top:12px; margin-bottom:12px ;font-size:18px;">{{$category_name}}</h2>
        <h2 class="productosDestacados"
        ...
        <form class="formulario form desaparecer" action="/size/store/{{$category_id}}" method="POST">
            @csrf
            ...
            <div
                ...
                <label for="" style="color: black; font-size:16px">AGREGAR UN TALLE</label> <br>
                <p>Ingrese el talle</p>
                <input type="text" placeholder="Escribir" name="size"
        ...
        <div class="xD" style="width: 100%; display:flex;justify-content:center; align-items:center;">
            <a href="/product/create/{{$category_id}}" style="width: 100%;text-decoration:none; color:white; text-align:center;display:flex;justify-content:center; align-items:center;">
        ...
        @foreach($category_xd->sizes as $size)
            <div class="caja-talle">
                <a href="" style="color:#333;" type="submit"><i
